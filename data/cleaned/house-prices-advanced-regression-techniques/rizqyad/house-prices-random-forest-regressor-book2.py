...
droped_cols = [col for col in X_train_full.columns if X_train_full[col].isnull().sum() > len(X_train_full) * 0.8]
print('droped columns:', droped_cols)
X_train_reduced = X_train_full.drop(droped_cols, axis=1)
...
all_cols = X_train_full.columns.values.tolist()
