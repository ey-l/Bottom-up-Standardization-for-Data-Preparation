...
training_data = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/train.csv')
testing_data = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/test.csv')
training_data.head()
...
corr.SalePrice
train_data = training_data.drop(['BsmtFinSF2', 'BsmtHalfBath', 'MiscVal', 'Id', 'LowQualFinSF', 'YrSold', 'OverallCond', 'MSSubClass', 'EnclosedPorch', 'GarageType', 'KitchenAbvGr', 'PoolQC', 'MiscFeature', 'Alley', 'Fence', 'FireplaceQu', 'SalePrice'], axis=1)
test_data = testing_data.drop(['BsmtFinSF2', 'BsmtHalfBath', 'MiscVal', 'Id', 'LowQualFinSF', 'YrSold', 'OverallCond', 'MSSubClass', 'EnclosedPorch', 'GarageType', 'KitchenAbvGr', 'PoolQC', 'MiscFeature', 'Alley', 'Fence', 'FireplaceQu'], axis=1)
