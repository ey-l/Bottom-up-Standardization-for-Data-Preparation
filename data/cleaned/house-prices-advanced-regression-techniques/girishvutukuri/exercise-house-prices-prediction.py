...
train_df = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/train.csv', na_values='?')
train_df.shape
train_df.head()
train_df.describe()
train_df.nunique()
...
train_df.isna().sum()
train_df.dtypes
train_df1 = train_df.drop(['Alley', 'Neighborhood', 'Exterior1st', 'Exterior2nd', 'FireplaceQu', 'PoolQC', 'Fence', 'MiscFeature', 'Utilities', 'ExterCond', 'Condition2', 'HouseStyle', 'RoofMatl', 'Exterior1st', 'Exterior2nd', 'Heating', 'Electrical', 'GarageQual', 'PoolQC', 'MiscFeature'], axis=1)
train_df1.shape
