...
dff.replace({'LotShape': lotshape, 'LandContour': landcontour, 'Utilities': utilities, 'LandSlope': landslope, 'BsmtExposure': bsmtexposure, 'BsmtFinType1': bsmtfintype, 'BsmtFinType2': bsmtfintype, 'Electrical': electrical, 'Functional': functional, 'GarageFinish': garagefinish, 'Fence': fence}, inplace=True)
