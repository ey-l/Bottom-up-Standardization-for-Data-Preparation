...
house_df_org = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/train.csv')
...
house_df.shape
test_org = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/test.csv')
