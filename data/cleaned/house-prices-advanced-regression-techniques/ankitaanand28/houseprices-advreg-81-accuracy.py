...
import numpy as nm
import matplotlib
train1 = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/train.csv')
test1 = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/test.csv')
test1.tail()
X1 = test1
id = X1.Id
datas = train1
