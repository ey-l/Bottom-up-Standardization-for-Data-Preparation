...
basic_insights(train, label='Train')
basic_insights(test, label='Test')
...
(X_train, X_test, y_train, y_test) = preprocessing(train.copy(), scaler, is_train=True, target='SalePrice')
