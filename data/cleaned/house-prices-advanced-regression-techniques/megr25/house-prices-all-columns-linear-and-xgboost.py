...
tcategorical = train[['SalePrice', 'KitchenQual', 'FireplaceQu', 'GarageQual', 'GarageFinish', 'GarageCond', 'BsmtCond', 'BsmtExposure', 'BsmtQual', 'BsmtFinType2', 'BsmtFinType1', 'ExterCond', 'ExterQual', 'HeatingQC', 'LandSlope', 'LotShape', 'PavedDrive', 'Street', 'BldgType', 'Functional', 'SaleType', 'GarageType', 'Electrical', 'Foundation', 'LandContour', 'RoofMatl', 'RoofStyle']]
