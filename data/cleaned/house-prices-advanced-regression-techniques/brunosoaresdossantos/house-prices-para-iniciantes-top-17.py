...
teste = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/test.csv')
treino = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/train.csv')
juntos = pd.concat([treino, teste])
print(teste.shape)
print(treino.shape)
print(juntos.shape)
juntos.head()
...
treino_num = pd.concat([treino_num, treino['SalePrice']], axis=1)
