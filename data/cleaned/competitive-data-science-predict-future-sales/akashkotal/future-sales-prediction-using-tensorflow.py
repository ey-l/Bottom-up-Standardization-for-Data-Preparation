...
monthly_data = train.pivot_table(index=['shop_id', 'item_id'], values=['item_cnt_day'], columns=['date_block_num'], fill_value=0, aggfunc='sum')
...
test_rows = monthly_data.merge(test, on=['item_id', 'shop_id'], how='right')
test_rows.head()
