...
data_t = pd.read_csv('data/input/spaceship-titanic/test.csv')
...
data1['Total_food'] = data1['RoomService'] + data1['FoodCourt']
data1['Total_recreation'] = data1['ShoppingMall'] + data1['VRDeck'] + data1['Spa']
...
sns.barplot(x='Transported', y='Total_spending', data=data1)
sns.barplot(x='Transported', y='Total_food', data=data1)
sns.barplot(x='Transported', y='Total_recreation', data=data1)
plt.figure(figsize=(10, 5))
sns.histplot(data=data1, x='Age', binwidth=1, kde=True)
plt.title('Age distribution')
plt.xlabel('Age (years)')
imp = SimpleImputer(strategy='median')
data1['Age'] = imp.fit_transform(data1[['Age']])
plt.figure(figsize=(10, 5))
sns.histplot(data=data1, x='Age', binwidth=1, kde=True)
plt.title('Age distribution')
plt.xlabel('Age (years)')
plt.figure(figsize=(10, 5))
sns.countplot(x='VIP', data=data1)
...
sns.pairplot(data1[['CryoSleep', 'Age', 'VIP', 'RoomService', 'FoodCourt', 'ShoppingMall', 'Spa', 'VRDeck', 'Transported', 'Total_spending', 'Total_food', 'Total_recreation']])
