...
org_train = pd.read_csv('data/input/spaceship-titanic/train.csv')
org_test = pd.read_csv('data/input/spaceship-titanic/test.csv')
org_sample_sub = pd.read_csv('data/input/spaceship-titanic/sample_submission.csv')
