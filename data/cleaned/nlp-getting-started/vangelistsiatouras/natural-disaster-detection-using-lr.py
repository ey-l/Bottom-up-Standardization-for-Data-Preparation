...
fake_df = df_train[df_train['target'] == 0]
...
df_train
fig = plt.figure(figsize=(10, 5))
sns.histplot(data=df_train, x='num_of_words')
...
fig = plt.figure(figsize=(10, 5))
sns.histplot(data=df_train, x='num_of_sentences')
...
fig = plt.figure(figsize=(10, 5))
sns.histplot(data=df_train, x='num_of_hashtags')
...
fig = plt.figure(figsize=(10, 5))
sns.histplot(data=df_train, x='num_of_references')
...
fig = plt.figure(figsize=(10, 5))
sns.histplot(data=df_train, x='num_of_urls')
...
X = df_train[['keyword', 'location', 'cleaned_text', 'num_of_sentences', 'num_of_hashtags', 'num_of_references', 'num_of_urls']]
y = df_train['target']
