...
df_train = pd.read_csv('data/input/nlp-getting-started/train.csv', na_values=missing_values)
df_test = pd.read_csv('data/input/nlp-getting-started/test.csv', na_values=missing_values)
df_train.head()
