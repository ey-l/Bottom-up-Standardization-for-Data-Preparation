...
keywords = list(_input1['keyword']) + list(_input0['keyword'])
...
plt.axis('off')
_input1 = make_feature_col(_input1)
_input1.head()
new_tweet_data_train = _input1.loc[:, ['id', 'Number of Disaster Words', 'target']]
new_tweet_data_train
_input0 = make_feature_col(_input0)
_input0 = _input0.loc[:, ['id', 'Number of Disaster Words']]
_input0.head()
