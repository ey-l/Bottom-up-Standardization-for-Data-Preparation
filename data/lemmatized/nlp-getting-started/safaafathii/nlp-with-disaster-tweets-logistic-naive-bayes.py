...
_input1.head()
_input1.shape
_input1[_input1['target'] == 1].shape
_input1[_input1['target'] == 0].shape
fig = plt.figure(figsize=(5, 5))
labels = ('Disaster', 'Non-Disaster')
sizes = [_input1[_input1['target'] == 1].shape[0], _input1[_input1['target'] == 0].shape[0]]
plt.pie(sizes, labels=labels, autopct='%1.1f%%', shadow=True, startangle=90)
plt.axis('equal')
df_dis = _input1[_input1['target'] == 1]
df_dis.shape
df_non_dis = _input1[_input1['target'] == 0]
df_non_dis.shape
...
preprocessing(_input1)
print('------------------------------------------------------------')
_input1.head()
wordFreq = {}
for (index, row) in _input1.iterrows():
