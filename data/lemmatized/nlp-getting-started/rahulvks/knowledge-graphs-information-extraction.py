...
_input1 = pd.read_csv('data/input/nlp-getting-started/train.csv', dtype={'id': np.int16, 'target': np.int8}, nrows=100)
_input0 = pd.read_csv('data/input/nlp-getting-started/test.csv', dtype={'id': np.int16}, nrows=100)
_input1.head()
