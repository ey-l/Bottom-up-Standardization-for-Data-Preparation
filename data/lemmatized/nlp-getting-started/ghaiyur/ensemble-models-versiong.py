...
print('There are {} rows and {} columns in train'.format(_input1.shape[0], _input1.shape[1]))
print('There are {} rows and {} columns in train'.format(_input0.shape[0], _input0.shape[1]))
_input1.info()
