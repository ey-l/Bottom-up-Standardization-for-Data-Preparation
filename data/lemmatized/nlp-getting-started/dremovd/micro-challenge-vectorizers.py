...
def load_data():
    _input1 = pd.read_csv('/kaggle/input/nlp-getting-started/train.csv')
    _input1['is_test'] = False
    _input0 = pd.read_csv('/kaggle/input/nlp-getting-started/test.csv')
    _input0['target'] = -1
    _input0['is_test'] = True
