...
nullTest = sum(list(_input0.isnull().sum()))
print('nullTrain:', nullTrain, ' - nullTest:', nullTest)
_input1['paidLuxury'] = (_input1.RoomService.fillna(_input1.groupby('HomePlanet')['CryoSleep'].transform('mean')) + _input1.RoomService.fillna(_input1.groupby('PassengerGrIdNb')['CryoSleep'].transform('median')) + _input1.RoomService.fillna(_input1.groupby('cabinDeck')['CryoSleep'].transform('median'))) / 3 + (_input1.FoodCourt.fillna(_input1.groupby('HomePlanet')['FoodCourt'].transform('mean')) + _input1.FoodCourt.fillna(_input1.groupby('PassengerGrIdNb')['FoodCourt'].transform('median')) + _input1.FoodCourt.fillna(_input1.groupby('cabinDeck')['FoodCourt'].transform('median'))) / 3 + (_input1.ShoppingMall.fillna(_input1.groupby('HomePlanet')['ShoppingMall'].transform('mean')) + _input1.ShoppingMall.fillna(_input1.groupby('PassengerGrIdNb')['ShoppingMall'].transform('median')) + _input1.ShoppingMall.fillna(_input1.groupby('cabinDeck')['ShoppingMall'].transform('median'))) / 3 + (_input1.Spa.fillna(_input1.groupby('HomePlanet')['Spa'].transform('mean')) + _input1.Spa.fillna(_input1.groupby('PassengerGrIdNb')['Spa'].transform('median')) + _input1.Spa.fillna(_input1.groupby('cabinDeck')['Spa'].transform('median'))) / 3 + (_input1.VRDeck.fillna(_input1.groupby('HomePlanet')['VRDeck'].transform('mean')) + _input1.VRDeck.fillna(_input1.groupby('PassengerGrIdNb')['VRDeck'].transform('median')) + _input1.VRDeck.fillna(_input1.groupby('cabinDeck')['VRDeck'].transform('median'))) / 3
_input1.RoomService = (_input1.RoomService.fillna(_input1.groupby('HomePlanet')['RoomService'].transform('mean')) + _input1.RoomService.fillna(_input1.groupby('PassengerGrIdNb')['RoomService'].transform('median')) + _input1.RoomService.fillna(_input1.groupby('cabinDeck')['RoomService'].transform('median'))) / 3
_input1.FoodCourt = (_input1.FoodCourt.fillna(_input1.groupby('HomePlanet')['FoodCourt'].transform('mean')) + _input1.FoodCourt.fillna(_input1.groupby('PassengerGrIdNb')['FoodCourt'].transform('median')) + _input1.FoodCourt.fillna(_input1.groupby('cabinDeck')['FoodCourt'].transform('median'))) / 3
_input1.ShoppingMall = (_input1.ShoppingMall.fillna(_input1.groupby('HomePlanet')['ShoppingMall'].transform('mean')) + _input1.ShoppingMall.fillna(_input1.groupby('PassengerGrIdNb')['ShoppingMall'].transform('median')) + _input1.ShoppingMall.fillna(_input1.groupby('cabinDeck')['ShoppingMall'].transform('median'))) / 3
_input1.Spa = (_input1.Spa.fillna(_input1.groupby('HomePlanet')['Spa'].transform('mean')) + _input1.Spa.fillna(_input1.groupby('PassengerGrIdNb')['Spa'].transform('median')) + _input1.Spa.fillna(_input1.groupby('cabinDeck')['Spa'].transform('median'))) / 3
_input1.VRDeck = (_input1.VRDeck.fillna(_input1.groupby('HomePlanet')['VRDeck'].transform('mean')) + _input1.VRDeck.fillna(_input1.groupby('PassengerGrIdNb')['VRDeck'].transform('median')) + _input1.VRDeck.fillna(_input1.groupby('cabinDeck')['VRDeck'].transform('median'))) / 3
_input1['paidLuxury'] = _input1.RoomService + _input1.FoodCourt + _input1.ShoppingMall + _input1.Spa + _input1.VRDeck
_input1.loc[_input1.paidLuxury.isna(), :]
print(_input1.groupby(['CryoSleep', 'paidLuxury']).size())
_input0['paidLuxury'] = (_input0.RoomService.fillna(_input1.groupby('HomePlanet')['CryoSleep'].transform('mean')) + _input0.RoomService.fillna(_input1.groupby('PassengerGrIdNb')['CryoSleep'].transform('median')) + _input0.RoomService.fillna(_input1.groupby('cabinDeck')['CryoSleep'].transform('median'))) / 3 + (_input0.FoodCourt.fillna(_input1.groupby('HomePlanet')['FoodCourt'].transform('mean')) + _input0.FoodCourt.fillna(_input1.groupby('PassengerGrIdNb')['FoodCourt'].transform('median')) + _input0.FoodCourt.fillna(_input1.groupby('cabinDeck')['FoodCourt'].transform('median'))) / 3 + (_input0.ShoppingMall.fillna(_input1.groupby('HomePlanet')['ShoppingMall'].transform('mean')) + _input0.ShoppingMall.fillna(_input1.groupby('PassengerGrIdNb')['ShoppingMall'].transform('median')) + _input0.ShoppingMall.fillna(_input1.groupby('cabinDeck')['ShoppingMall'].transform('median'))) / 3 + (_input0.Spa.fillna(_input1.groupby('HomePlanet')['Spa'].transform('mean')) + _input0.Spa.fillna(_input1.groupby('PassengerGrIdNb')['Spa'].transform('median')) + _input0.Spa.fillna(_input1.groupby('cabinDeck')['Spa'].transform('median'))) / 3 + (_input0.VRDeck.fillna(_input1.groupby('HomePlanet')['VRDeck'].transform('mean')) + _input0.VRDeck.fillna(_input1.groupby('PassengerGrIdNb')['VRDeck'].transform('median')) + _input0.VRDeck.fillna(_input1.groupby('cabinDeck')['VRDeck'].transform('median'))) / 3
_input0.RoomService = (_input0.RoomService.fillna(_input1.groupby('HomePlanet')['RoomService'].transform('mean')) + _input0.RoomService.fillna(_input1.groupby('PassengerGrIdNb')['RoomService'].transform('median')) + _input0.RoomService.fillna(_input1.groupby('cabinDeck')['RoomService'].transform('median'))) / 3
_input0.FoodCourt = (_input0.FoodCourt.fillna(_input1.groupby('HomePlanet')['FoodCourt'].transform('mean')) + _input0.FoodCourt.fillna(_input1.groupby('PassengerGrIdNb')['FoodCourt'].transform('median')) + _input0.FoodCourt.fillna(_input1.groupby('cabinDeck')['FoodCourt'].transform('median'))) / 3
_input0.ShoppingMall = (_input0.ShoppingMall.fillna(_input1.groupby('HomePlanet')['ShoppingMall'].transform('mean')) + _input0.ShoppingMall.fillna(_input1.groupby('PassengerGrIdNb')['ShoppingMall'].transform('median')) + _input0.ShoppingMall.fillna(_input1.groupby('cabinDeck')['ShoppingMall'].transform('median'))) / 3
_input0.Spa = (_input0.Spa.fillna(_input1.groupby('HomePlanet')['Spa'].transform('mean')) + _input0.Spa.fillna(_input1.groupby('PassengerGrIdNb')['Spa'].transform('median')) + _input0.Spa.fillna(_input1.groupby('cabinDeck')['Spa'].transform('median'))) / 3
_input0.VRDeck = (_input0.VRDeck.fillna(_input1.groupby('HomePlanet')['VRDeck'].transform('mean')) + _input0.VRDeck.fillna(_input1.groupby('PassengerGrIdNb')['VRDeck'].transform('median')) + _input0.VRDeck.fillna(_input1.groupby('cabinDeck')['VRDeck'].transform('median'))) / 3
...
import seaborn as sns
import matplotlib.pyplot as plt
Polynom_Nan_cabinDeck_HomePlanet = _input1.groupby(['cabinDeck', 'HomePlanet']).size().unstack()
plt.figure(figsize=(25, 6))
sns.heatmap(Polynom_Nan_cabinDeck_HomePlanet.T, annot=True, fmt='g', cmap='coolwarm')
Polynom_Nan_cabinDeck_HomePlanet = _input1.groupby(['cabinDeck', 'Destination']).size().unstack()
plt.figure(figsize=(25, 6))
sns.heatmap(Polynom_Nan_cabinDeck_HomePlanet.T, annot=True, fmt='g', cmap='coolwarm')
_input1.columns
Polynom_Nan_cabinDeck_HomePlanet = _input1.groupby(['cabinDeck', 'cabinSide', 'CryoSleep', 'VIP', 'PassengerLN', 'Transported']).size().unstack()
plt.figure(figsize=(70, 20))
sns.heatmap(Polynom_Nan_cabinDeck_HomePlanet.T, annot=True, fmt='g', cmap='coolwarm')
_input1.groupby(['cabinDeck', 'cabinSide', 'CryoSleep', 'VIP', 'Transported']).size().unstack().sum()
Polynom_Nan_cabinDeck_HomePlanet = _input0.groupby(['cabinDeck', 'cabinSide', 'CryoSleep', 'VIP']).size().unstack()
plt.figure(figsize=(25, 6))
sns.heatmap(Polynom_Nan_cabinDeck_HomePlanet.T, annot=True, fmt='g', cmap='coolwarm')
Polynom_Nan_cabinDeck_HomePlanet = _input1.groupby(['cabinDeck', 'Destination']).size().unstack()
plt.figure(figsize=(25, 6))
sns.heatmap(Polynom_Nan_cabinDeck_HomePlanet.T, annot=True, fmt='g', cmap='coolwarm')
Polynom_Nan_cabinDeck_HomePlanet = _input1.groupby(['cabinDeck', 'HomePlanet', 'PassengerGrIdNb', 'CryoSleep']).size().unstack()
plt.figure(figsize=(25, 6))
sns.heatmap(Polynom_Nan_cabinDeck_HomePlanet.T, annot=True, fmt='g', cmap='coolwarm')
Polynom_Nan_cabinDeck_HomePlanet = _input1.groupby(['cabinDeck', 'HomePlanet', 'PassengerGrIdNb', 'PassengerLN']).size().unstack()
plt.figure(figsize=(30, 30))
sns.heatmap(Polynom_Nan_cabinDeck_HomePlanet.T, annot=True, fmt='g', cmap='coolwarm')
Polynom_Nan_cabinDeck_HomePlanet = _input1.groupby(['cabinDeck', 'HomePlanet', 'PassengerGrIdNb', 'Destination']).size().unstack()
plt.figure(figsize=(30, 6))
sns.heatmap(Polynom_Nan_cabinDeck_HomePlanet.T, annot=True, fmt='g', cmap='coolwarm')
Polynom_Nan_cabinDeck_PassengerGrIdNb = _input1.groupby(['cabinDeck', 'PassengerGrIdNb', 'CryoSleep']).size().unstack()
plt.figure(figsize=(30, 6))
...
cat_cols = [col for col in _input1.columns if _input1[col].dtype == 'object' or _input1[col].dtype == 'category']
numeric_cols = [col for col in _input1.columns if _input1[col].dtype == 'float64']
for i in _input1.columns:
    if _input1[i].isna().sum() > 0:
        if i in cat_cols:
            _input1[i] = _input1[i].fillna(_input1[i].value_counts(ascending=True).index[-1])
for i in _input1.columns:
    if _input1[i].isna().sum() > 0:
        if i in numeric_cols:
            _input1[i] = _input1[i].fillna(_input1.groupby('HomePlanet')[i].transform('mean'))
_input1.isna().sum()