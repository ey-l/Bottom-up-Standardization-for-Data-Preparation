...
fig = sns.countplot(data=_input1, x='CryoSleep', hue='Transported')
fig = sns.countplot(data=_input1, x='HomePlanet', hue='Transported')
fig = sns.countplot(data=_input1, x='Destination', hue='Transported')
...
fig = sns.countplot(data=_input1, x='Side', hue='Transported')
...
fig = sns.countplot(x=_input1['VIP'])
