...
sns.heatmap(_input1.corr(), annot=True, fmt='.2f')
_input1.isnull().sum()
...
def clean_data(df):
    ...
    return cleaned_df
cleaned_train_df = clean_data(_input1)
print(_input1['Transported'].isnull().sum())
cleaned_train_df['transported'] = _input1['Transported']
corr = cleaned_train_df.corr()
sns.heatmap(corr, xticklabels=corr.columns, yticklabels=corr.columns, annot=True)
_input1 = cleaned_train_df.drop(['transported'], axis=1)
