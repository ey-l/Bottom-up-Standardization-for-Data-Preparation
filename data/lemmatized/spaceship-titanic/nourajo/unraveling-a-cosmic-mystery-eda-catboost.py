...
_input1.hist(column=['Age', 'RoomService', 'FoodCourt', 'ShoppingMall', 'Spa', 'VRDeck'], sharex=False, sharey=False, color='purple', grid=False)
plt.suptitle('Training Set Numerical Features Distribution\n', fontsize=15, font='serif')
plt.tight_layout()
sns.despine()
_input0.hist(column=['Age', 'RoomService', 'FoodCourt', 'ShoppingMall', 'Spa', 'VRDeck'], sharex=False, sharey=False, color='purple', grid=False)
plt.suptitle('Testing Set Numerical Features Distribution\n', fontsize=15, font='serif')
plt.tight_layout()
sns.despine()
g = sns.countplot(x=_input1['Transported'], color='purple')
plt.title('The Number of People Transported\n', loc='left', size=15, font='serif')
sns.despine()
g.bar_label(g.containers[0], size=15, font='serif')
g = sns.countplot(data=_input1, x='HomePlanet', color='purple')
plt.title('Frequency of Home Planets\n', loc='left', fontsize=15, font='serif')
g.bar_label(g.containers[0], size=15, font='serif')
plt.tight_layout()
sns.despine()
g = sns.countplot(data=_input1, x='CryoSleep', color='purple')
...
plt.tight_layout()
sns.despine()
without_hue(g, _input1.CryoSleep)
_input1.Cabin.nunique()
g = sns.countplot(x=_input1.Destination, color='purple')
plt.title('Frequency of Destinations\n', loc='left', fontsize=15, font='serif')
g.bar_label(g.containers[0], size=15, font='serif')
plt.tight_layout()
sns.despine()
g = sns.countplot(x=_input1.VIP, color='purple')
plt.title('Frequency of VIP Passengers\n', loc='left', fontsize=15, font='serif')
g.bar_label(g.containers[0], size=15, font='serif')
plt.tight_layout()
sns.despine()
g = sns.countplot(data=_input1, x='HomePlanet', hue='Transported', palette={True: '#682079', False: '#D3E7F7'}, color='purple')
plt.title('Frequency of Home Planets Given Transported Status\n', loc='left', fontsize=15, font='serif')
g.bar_label(g.containers[0], size=15, font='serif')
g.bar_label(g.containers[1], size=15, font='serif')
plt.tight_layout()
sns.despine()
_input1[['HomePlanet', 'Transported']].value_counts(normalize=True) * 100
g = sns.countplot(data=_input1, x='CryoSleep', color='purple', palette={True: '#682079', False: '#D3E7F7'}, hue='Transported')
plt.title('Frequency of Passenger in CryoSleep\n\n', loc='left', fontsize=15, font='serif')
g.bar_label(g.containers[0], size=15, font='serif')
g.bar_label(g.containers[1], size=15, font='serif')
plt.tight_layout()
sns.despine()
_input1[['CryoSleep', 'Transported']].value_counts(normalize=True) * 100
g = sns.countplot(data=_input1, x='Destination', color='purple', palette={True: '#682079', False: '#D3E7F7'}, hue='Transported')
plt.title('Frequency of Destinations\n', loc='left', fontsize=15, font='serif')
g.bar_label(g.containers[0], size=15, font='serif')
g.bar_label(g.containers[1], size=15, font='serif')
plt.tight_layout()
sns.despine()
_input1[['Destination', 'Transported']].value_counts(normalize=True) * 100
g = sns.countplot(x=_input1.VIP, color='purple', palette={True: '#682079', False: '#D3E7F7'}, hue=_input1.Transported)
plt.title('Frequency of VIP Passengers\n', loc='left', fontsize=15, font='serif')
g.bar_label(g.containers[0], size=15, font='serif')
g.bar_label(g.containers[1], size=15, font='serif')
plt.tight_layout()
sns.despine()
_input1[['VIP', 'Transported']].value_counts(normalize=True) * 100
g = sns.histplot(hue=_input1['Transported'], x=_input1['Age'], palette={True: '#682079', False: '#D3E7F7'}, discrete=True, kde=True, multiple='stack')
plt.title('The Distribution of People Transported Given Their Age\n', loc='left', size=15, font='serif')
sns.despine()
g = sns.histplot(hue=_input1['Transported'], x=_input1['Age'].loc[_input1['Age'] >= 60], palette={True: '#682079', False: '#D3E7F7'}, multiple='stack')
...
df_train1 = _input1.loc[_input1['RoomService'] != 0]
...
sns.despine()
df_train1 = _input1.loc[_input1['ShoppingMall'] > 4000]
g = sns.histplot(hue=df_train1['Transported'], x=df_train1['ShoppingMall'], palette={True: '#682079', False: '#D3E7F7'}, multiple='stack')
plt.title("The Distribution of People Transported Given Their Shopping Mall Bill\nExcluding People Who Didn't Spend Any Money", loc='left', size=15, font='serif')
sns.despine()
df_train1 = _input1.loc[_input1['Spa'] != 0]
...
_input0 = _input0.drop(['PassengerId', 'Name', 'Cabin'], axis=1, inplace=False)
_input1 = pd.get_dummies(_input1)
_input0 = pd.get_dummies(_input0)
from sklearn.model_selection import train_test_split
(X_train, X_val, y_train, y_val) = train_test_split(_input1.drop('Transported', axis=1), _input1['Transported'], test_size=0.2, random_state=0)
