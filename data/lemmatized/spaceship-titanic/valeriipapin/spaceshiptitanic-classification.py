...
_input1.head()
_input0.head()
Y_train = _input1[['PassengerId', 'Transported']]
Y_train
_input1.describe()
_input1.nunique()
X_train = _input1.drop(axis=1, columns=['Name', 'Transported'])
X_train
X_test = _input0.drop(axis=1, columns=['Name'])
X_test
X_train.isna().sum()
...
Y_train.Transported
_input2.Transported.describe()
_input2.Transported = _input2.Transported.apply(replaceBoolean)
_input2.Transported
