...
_input1.info()
_input1.isna().any()
print(f"Home Planet Unique Values => {_input1['HomePlanet'].unique()}")
print(f"Destination Unique Values => {_input1['Destination'].unique()}")
...
l1 = LabelEncoder()
(df_train, _) = preprocess_data(_input1)
