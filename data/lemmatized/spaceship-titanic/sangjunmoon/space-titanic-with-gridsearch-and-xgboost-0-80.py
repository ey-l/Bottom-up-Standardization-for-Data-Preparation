...
_input1['Is_train'] = True
_input0 = pd.read_csv('data/input/spaceship-titanic/test.csv')
_input0['Is_train'] = False
data = pd.concat([_input1.drop('Transported', axis=1), _input0], axis=0, ignore_index=True)
...
obj_data = obj_data.drop(['Front_Id', 'Rear_Id', 'Num'], axis=1, inplace=False)
...
data_train_y = _input1['Transported']
