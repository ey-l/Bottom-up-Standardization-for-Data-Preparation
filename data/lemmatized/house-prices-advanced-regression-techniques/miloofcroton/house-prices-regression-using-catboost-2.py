...
_input1 = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/train.csv', encoding='utf-8')
_input0 = pd.read_csv('_data/input/house-prices-advanced-regression-techniques/test.csv', encoding='utf-8')
...
def preprocess(cat_features, num_features):
    ...
    for column in num_features:
        num_features[column] = num_features[column].fillna(np.nanmean(num_features[column]), inplace=False)
