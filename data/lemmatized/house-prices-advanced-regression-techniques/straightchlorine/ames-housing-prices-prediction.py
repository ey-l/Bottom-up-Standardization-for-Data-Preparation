...
is_outlier = (_input1['GrLivArea'] > 4000) & (_input1['SalePrice'] < 700000)
(fig, ax) = plt.subplots(figsize=(12, 8))
sns.scatterplot(data=_input1, x='GrLivArea', y='SalePrice', hue=is_outlier, ax=ax, legend=False)
fig.show()
_input1 = _input1.drop(_input1[(_input1['GrLivArea'] > 4000) & (_input1['SalePrice'] < 700000)].index)
(fig, ax) = plt.subplots(figsize=(12, 8))
sns.scatterplot(data=_input1, x='GrLivArea', y='SalePrice', ax=ax)
train_copy = _input1.copy().drop('SalePrice', axis=1)
...
df_total['MasVnrArea'] = df_total['MasVnrArea'].where(df_total['MasVnrArea'].notna(), 0, inplace=False)
df_total['MasVnrType'] = df_total['MasVnrType'].where(df_total['MasVnrType'].notna(), 'None', inplace=False)
df_total['BsmtQual'] = df_total['BsmtQual'].where(df_total['TotalBsmtSF'] != 0, 'NA', inplace=False)
df_total['BsmtCond'] = df_total['BsmtCond'].where(df_total['TotalBsmtSF'] != 0, 'NA', inplace=False)
df_total['BsmtExposure'] = df_total['BsmtExposure'].where(df_total['TotalBsmtSF'] != 0, 'NA', inplace=False)
df_total['BsmtFinType1'] = df_total['BsmtFinType1'].where(df_total['TotalBsmtSF'] != 0, 'NA', inplace=False)
df_total['BsmtFinType2'] = df_total['BsmtFinType2'].where(df_total['TotalBsmtSF'] != 0, 'NA', inplace=False)
df_total['BsmtFullBath'] = df_total['BsmtFullBath'].where(df_total['TotalBsmtSF'] != 0, 0.0, inplace=False)
df_total['BsmtHalfBath'] = df_total['BsmtHalfBath'].where(df_total['TotalBsmtSF'] != 0, 0.0, inplace=False)
df_total['BsmtFinSF1'] = df_total['BsmtFinSF1'].where(df_total['TotalBsmtSF'] != 0, 0.0, inplace=False)
df_total['BsmtFinSF2'] = df_total['BsmtFinSF2'].where(df_total['TotalBsmtSF'] != 0, 0.0, inplace=False)
df_total['BsmtUnfSF'] = df_total['BsmtUnfSF'].where(df_total['TotalBsmtSF'] != 0, 0.0, inplace=False)
df_total['GarageCond'] = df_total['GarageCond'].where(df_total['GarageArea'] != 0, 'NA', inplace=False)
df_total['GarageQual'] = df_total['GarageQual'].where(df_total['GarageArea'] != 0, 'NA', inplace=False)
df_total['GarageFinish'] = df_total['GarageFinish'].where(df_total['GarageArea'] != 0, 'NA', inplace=False)
df_total['GarageType'] = df_total['GarageType'].where(df_total['GarageArea'] != 0, 'NA', inplace=False)
...
df_total['FireplaceQu'] = df_total['FireplaceQu'].where(df_total['Fireplaces'] != 0, 'NA', inplace=False)
df_total['PoolQC'] = df_total['PoolQC'].where(df_total['PoolArea'] != 0, 'NA', inplace=False)
df_total['PoolQC'] = df_total['PoolQC'].fillna(df_total['PoolQC'][df_total['PoolArea'] != 0].mode()[0])
df_total['MiscFeature'] = df_total['MiscFeature'].where(df_total['MiscVal'] != 0, 'NA', inplace=False)
df_total['MiscFeature'] = df_total['MiscFeature'].fillna('Othr')
df_total['SaleType'] = df_total['SaleType'].fillna(df_total['SaleType'].mode()[0])
df_total = df_total.drop(axis=1, columns=['Alley', 'Fence'], errors='ignore', inplace=False)
df_total.info()
...
df_num_ord = df_num_ord.drop(high_corr_features, axis=1, inplace=False, errors='ignore')
df_total = df_total.drop(high_corr_features, axis=1, inplace=False, errors='ignore')
