...
plt.scatter(_input1.GrLivArea, _input1.SalePrice, c='orange', s=90, alpha=0.4)
...
_input1 = _input1.drop(_input1[(_input1['GrLivArea'] > 4000) & (_input1['SalePrice'] < 200000)].index, inplace=False)
plt.figure(figsize=(15, 10))
plt.scatter(_input1.GrLivArea, _input1.SalePrice, c='orange', s=90, alpha=0.4)
plt.ylabel('Sales Price', fontsize=15)
plt.xlabel('GrLivArea', fontsize=15)
...
for rw in range(2):
    plt.sca(axs[rw][0])
    sns.distplot(_input1['SalePrice'], fit=norm, ax=plt.gca())