...
sns.histplot(x=_input1['SalePrice'])
sns.boxplot(data=_input1, x='SalePrice')
...
_input1[_input1['GrLivArea'] > 4000]
plt.figure(figsize=(10, 5), dpi=200)
sns.scatterplot(x=_input1['OverallQual'], y=_input1['SalePrice'])
_input1[(_input1['OverallQual'] == 10) & (_input1['SalePrice'] < 200000)]
drop_ind = _input1[(_input1['OverallQual'] == 10) & (_input1['SalePrice'] < 200000)].index
_input1 = _input1.drop(drop_ind, axis=0)
plt.figure(figsize=(10, 5), dpi=200)
sns.scatterplot(x=_input1['GrLivArea'], y=_input1['SalePrice'])
plt.figure(figsize=(15, 10), dpi=200)
sns.heatmap(_input1.corr(), annot=False)
_input0.info()
main_df = pd.concat([_input1, _input0], ignore_index=True)
main_df
main_df.info()
