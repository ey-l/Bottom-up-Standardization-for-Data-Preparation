...
print('There are %d instances' % _input1.shape[0])
print('There are %d features' % _input1.shape[1])
...
del_cols
print('Initial data shape:', _input1.shape)
train_nona = _input1.drop(columns=del_cols)
