...
_input1['SalePrice'].describe().transpose()
g = sns.displot(_input1['SalePrice'], kde=True, bins=20)
g.fig.set_size_inches(10, 8)
plt.savefig('./displot.png', dpi=150, bbox_inches='tight')
print('Sale Price skewness:', _input1['SalePrice'].skew())
_input1.info()
data_train_num = _input1.select_dtypes(exclude='object')
...
_input1[col_name].isnull().sum()
new_data = _input1[col_name]
...
new_data = new_data.drop(new_data[new_data['GrLivArea'] > 4000].index, inplace=False)
sns.scatterplot(x=new_data['GrLivArea'], y=new_data['SalePrice'])
