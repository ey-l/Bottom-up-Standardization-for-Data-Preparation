...
_input1.head()
_input1.head()
_input1[_input1.SalePrice > 300000]
_input1.tail()
_input1.info()
_input1.describe()
correlation_train = _input1.corr()
sb.set(font_scale=2)
...
sb.boxplot(x='YearBuilt', y='SalePrice', data=_input1)
sb.swarmplot(x='YearBuilt', y='SalePrice', data=_input1, color='.25')
plt.xticks(weight='bold', rotation=90)
_input0.head()
_input0.tail()
_input0.info()
_input0.describe()
train_test = pd.concat([_input1, _input0], axis=0, sort=False)
train_test.head()
pd.set_option('display.max_rows', 5000)
...
train_test['LotFrontage'] = train_test['LotFrontage'].interpolate(method='linear', inplace=False)
...
train_test['MasVnrArea'] = train_test['MasVnrArea'].interpolate(method='linear', inplace=False)
