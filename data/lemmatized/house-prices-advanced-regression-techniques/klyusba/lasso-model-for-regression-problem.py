...
all_data = pd.concat((_input1.loc[:, 'MSSubClass':'SaleCondition'], _input0.loc[:, 'MSSubClass':'SaleCondition']), ignore_index=True)
...
svm = SVC(C=100)
pc = pd.Series(np.zeros(_input1.shape[0]))
pc[:] = 'pc1'
pc[_input1.SalePrice >= 150000] = 'pc2'
pc[_input1.SalePrice >= 220000] = 'pc3'
columns_for_pc = ['Exterior1st', 'Exterior2nd', 'RoofMatl', 'Condition1', 'Condition2', 'BldgType']
X_t = pd.get_dummies(_input1.loc[:, columns_for_pc], sparse=True)