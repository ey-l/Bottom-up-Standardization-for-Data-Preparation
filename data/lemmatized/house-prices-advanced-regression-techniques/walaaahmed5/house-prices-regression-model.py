...
print('train data : {}'.format(_input1.shape))
print('test data : {}'.format(_input0.shape))
train_id = _input1['Id']
test_id = _input0['Id']
...
all_data = pd.concat((_input1, _input0), ignore_index=True)
print('all_data size is : {}'.format(all_data.shape))
all_data.head()
all_data.info()
all_data = all_data.drop(['Alley', 'PoolQC', 'Fence', 'MiscFeature', 'FireplaceQu'], axis=1, inplace=False)
all_data.shape
print(all_data[['BsmtFinSF1', 'BsmtFinSF2', 'BsmtUnfSF', 'TotalBsmtSF']].head())
all_data = all_data.drop(['BsmtFinSF1', 'BsmtFinSF2', 'BsmtUnfSF'], axis=1, inplace=False)
all_data.shape
...
all_data = all_data.replace(ordinal_mapping, inplace=False)
all_data.info()
all_data.head()
