...
print('The shape of our training set: ', _input1.shape[0], 'houses', 'and', _input1.shape[1], 'features')
print('The shape of our testing set: ', _input0.shape[0], 'houses', 'and', _input0.shape[1], 'features')
...
_input1.columns
_input0.columns
numeric = _input1.select_dtypes(exclude='object')
categorical = _input1.select_dtypes(include='object')
...
sns.heatmap(_input1.corr(), annot=True, linewidths=0.1, fmt='.1f', ax=ax, cmap='YlGnBu')
k = 10
...
na = _input1.shape[0]
nb = _input0.shape[0]
y_train = _input1['SalePrice'].to_frame()
c1 = pd.concat((_input1, _input0), sort=False).reset_index(drop=True)
c1 = c1.drop(['SalePrice'], axis=1, inplace=False)
c1 = c1.drop(['Id'], axis=1, inplace=False)
...
plt.scatter(x=_input1['GrLivArea'], y=_input1['SalePrice'], color='yellowgreen', alpha=0.5)
plt.axvline(x=4600, color='r', linestyle='-')
plt.title('Ground living Area- Price scatter plot', fontsize=15, weight='bold')
ax1 = plt.subplot2grid((3, 2), (0, 1))
plt.scatter(x=_input1['TotalBsmtSF'], y=_input1['SalePrice'], color='red', alpha=0.5)
plt.axvline(x=5900, color='r', linestyle='-')
plt.title('Basement Area - Price scatter plot', fontsize=15, weight='bold')
ax1 = plt.subplot2grid((3, 2), (1, 0))
plt.scatter(x=_input1['1stFlrSF'], y=_input1['SalePrice'], color='deepskyblue', alpha=0.5)
plt.axvline(x=4000, color='r', linestyle='-')
plt.title('First floor Area - Price scatter plot', fontsize=15, weight='bold')
ax1 = plt.subplot2grid((3, 2), (1, 1))
plt.scatter(x=_input1['MasVnrArea'], y=_input1['SalePrice'], color='gold', alpha=0.9)
plt.axvline(x=1500, color='r', linestyle='-')
plt.title('Masonry veneer Area - Price scatter plot', fontsize=15, weight='bold')
ax1 = plt.subplot2grid((3, 2), (2, 0))
plt.scatter(x=_input1['GarageArea'], y=_input1['SalePrice'], color='orchid', alpha=0.5)
plt.axvline(x=1230, color='r', linestyle='-')
plt.title('Garage Area - Price scatter plot', fontsize=15, weight='bold')
ax1 = plt.subplot2grid((3, 2), (2, 1))
plt.scatter(x=_input1['TotRmsAbvGrd'], y=_input1['SalePrice'], color='tan', alpha=0.9)
...
_input1['TotalBsmtSF'].sort_values(ascending=False).head(1)
_input1['MasVnrArea'].sort_values(ascending=False).head(1)
_input1['1stFlrSF'].sort_values(ascending=False).head(1)
_input1['GarageArea'].sort_values(ascending=False).head(4)
_input1['TotRmsAbvGrd'].sort_values(ascending=False).head(1)
...
target.loc[523]
pos = [1298, 523, 297]
target = target.drop(target.index[pos], inplace=False)
...
plt.scatter(x=_input1['GrLivArea'], y=_input1['SalePrice'], color='orchid', alpha=0.5)
...
print('Skewness before log transform: ', _input1['GrLivArea'].skew())
print('Kurtosis before log transform: ', _input1['GrLivArea'].kurt())
...
sns.distplot(_input1.GrLivArea, color='plum')
plt.title('Before: Distribution of GrLivArea', weight='bold', fontsize=18)
ax1 = plt.subplot2grid((2, 2), (0, 1))
sns.distplot(_input1['1stFlrSF'], color='tan')
...
fig = plt.figure(figsize=(15, 5))
ax1 = plt.subplot2grid((1, 2), (0, 0))
plt.hist(_input1.SalePrice, bins=10, color='mediumpurple', alpha=0.5)
