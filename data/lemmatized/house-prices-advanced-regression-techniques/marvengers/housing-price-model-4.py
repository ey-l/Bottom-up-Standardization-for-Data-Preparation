...
_input1.info()
_input0.info()
numerical = _input1.select_dtypes(include=['int64', 'float64'])
numerical_test = _input0.select_dtypes(include=['int64', 'float64'])
numerical
...
categorical_test = _input0.select_dtypes(include='object')
categorical
categorical.info()
