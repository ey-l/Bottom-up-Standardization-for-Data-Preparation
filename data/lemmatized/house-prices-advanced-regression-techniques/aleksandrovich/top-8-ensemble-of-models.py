...
features = pd.concat([train_features, _input0]).reset_index(drop=True)
...
_input1 = final_features.iloc[:len(y), :]
_input0 = final_features.iloc[len(_input1):, :]
print('Features size for train(X,y) and test(X_test):')
print('X', _input1.shape, 'y', y.shape, 'X_test', _input0.shape)
