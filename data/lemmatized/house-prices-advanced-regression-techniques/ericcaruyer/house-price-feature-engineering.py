...
df_all.name = 'All Set'
dfs = [_input1, _input0]
print(f'Number of Training Examples = {_input1.shape[0]}')
print(f'Number of Test Examples = {_input0.shape[0]}\n')
print(f'Training X Shape = {_input1.shape}')
print(f"Training y Shape = {_input1['SalePrice'].shape[0]}\n")
print(f'Test X Shape = {_input0.shape}')
print(f'Test y Shape = {_input0.shape[0]}\n')
...
(_input1, _input0) = divide_df(df_all)
score_dataset(_input1, y_train)
y_SqFeetPrice = y_train / _input1['TotalSF']
